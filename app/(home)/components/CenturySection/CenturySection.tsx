...
export default function CenturySection() {
  ...
  // Phase 1: Left/Right movement during image (0.05 - 0.25)
  // Phase 2: Founder text appears when section visible (0.15+)
  ...
  const founderTextOpacity = Math.max(0, Math.min(1, (scrollProgress - 0.15) / 0.3));
    ...
    <div ref={containerRef} className="century-section-container">
      ...
      >
        ...
        <div className="century-content">
          ...
          >
            <div className="century-founder-layout">
              <div className="century-founder-icon">
                <div className="century-founder-icon-circle">
                  <TimeSvg />
                </div>
              </div>
