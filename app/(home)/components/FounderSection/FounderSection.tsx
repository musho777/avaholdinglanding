        ...
        <div className="founder-content-centered">
          ...
          <div className="founder-bio">
            ...
            <p className="founder-paragraph scroll-reveal delay-3">
              ...
              portfolio includes residential communities, commercial real estate, a business centre
              and logistics warehouse facilities. The company's flagship development, "AVA
              Residences", is a premium residential complex in Yerevan featuring interiors by "Elie
              Saab Maison".
            </p>
            <p className="founder-paragraph scroll-reveal delay-3">
