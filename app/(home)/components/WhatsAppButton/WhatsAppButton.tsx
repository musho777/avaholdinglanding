...
export default function WhatsAppButton() {
  ...
  const handleClick = () => {
    ...
    const message = encodeURIComponent("Hello! I'm interested in AVA Residence.");
  ...
  return (
    <div className={`whatsapp-button-wrapper ${isHidden ? "hidden" : ""}`}>
      <button
        ...
        type="button"
      >
        <span className="whatsapp-wave whatsapp-wave-1"></span>
        <span className="whatsapp-wave whatsapp-wave-2"></span>
        <span className="whatsapp-wave whatsapp-wave-3"></span>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
